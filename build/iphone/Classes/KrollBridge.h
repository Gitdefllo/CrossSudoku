...
@interface CrossSudokuObject : KrollCoverageObject {
#else
@interface CrossSudokuObject : KrollObject {
#endif
@private
...
extern NSString * CrossSudoku$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CrossSudokuObject *_crosssudoku;
    KrollObject* console;
	BOOL shutdown;
