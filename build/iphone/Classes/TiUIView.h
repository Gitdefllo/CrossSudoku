...
/**
 Base class for all CrossSudoku views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CrossSudoku view hierarchy (such as wrapped iOS UIViews) was touched.
