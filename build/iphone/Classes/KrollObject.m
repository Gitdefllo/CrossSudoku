...
//@interface CrossSudokuObject : NSObject
//@end

@interface CrossSudokuObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CrossSudokuObject class]])
		{
			for (NSString *key in [[(CrossSudokuObject*)o modules] allKeys])
			{
