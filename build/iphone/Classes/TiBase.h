...
// in simulator we redefine to format for CrossSudoku Developer console
...
{\
	NSString * exceptionName = [@"org.crosssudoku." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.crosssudoku";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICrossSudokuNativeItemNone = -1, 
	UICrossSudokuNativeItemSpinner = -2,
	UICrossSudokuNativeItemProgressBar = -3,
	
	UICrossSudokuNativeItemSlider = -4,
	UICrossSudokuNativeItemSwitch = -5,
	UICrossSudokuNativeItemMultiButton = -6,
	UICrossSudokuNativeItemSegmented = -7,
	
	UICrossSudokuNativeItemTextView = -8,
	UICrossSudokuNativeItemTextField = -9,
	UICrossSudokuNativeItemSearchBar = -10,
	
	UICrossSudokuNativeItemPicker = -11,
	UICrossSudokuNativeItemDatePicker = -12,
	
	UICrossSudokuNativeItemInfoLight = -13,
	UICrossSudokuNativeItemInfoDark = -14,
	
	UICrossSudokuNativeItemDisclosure = -15,
	
	UICrossSudokuNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CrossSudoku instances of
